...
.Data[] | [{Setup: (2016), (.Holds[].Location.Description): (({ Holdset: .Description, Orientation: .Holds[].Location.DirectionString, Number: .Holds[].Location.HoldNumber, hh: .Holds[].Location.Description} ))} ] 
